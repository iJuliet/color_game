...
OAuth.prototype.getBaseString = function(request, oauth_data) {
    return request.method + '&' + this.percentEncode(this.getBaseUrl(request.url)) + '&' + this.percentEncode(this.getParameterString(request, oauth_data));
};
...
OAuth.prototype.getBaseUrl = function(url) {
    if (url !== undefined) {return url.split('?')[0];}
    return "";
};
